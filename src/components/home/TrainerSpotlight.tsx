            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg max-w-2xl mx-auto">
                        Learn from experienced professionals dedicated to your boxing success
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    {/* Content column */}
                    <div>
                        <h3 className="font-primary font-bold text-2xl mb-2">Coach Martinez</h3>
                        <p className="text-boxing-red font-semibold mb-6">Head Boxing Coach & Founder</p>

                        <div className="mb-6">
                            <div className="flex items-center mb-3">
                                <FiAward className="text-boxing-red mr-3" size={24} />
                                <p className="font-semibold">20+ Years Professional Experience</p>
                            </div>
                            <div className="flex items-center mb-3">
                                <FiUsers className="text-boxing-red mr-3" size={24} />
                                <p className="font-semibold">Trained Both Amateur & Professional Boxers</p>
                            </div>
                        </div>

                        <p className="text-caption-text mb-6">
                            With over two decades of boxing expertise, Coach Martinez has trained champions at all levels of competition. His deep knowledge, personalized approach, and dedication to the sport have helped countless athletes reach their full potential.
                        </p>

                        <div className="mb-6">
                            <h4 className="font-semibold mb-3">Specializations:</h4>
                            <ul className="space-y-2">
                                {["Technical Boxing Skills", "Competition Strategy", "Elite Performance Training", "Youth Development"].map((item, index) => (
