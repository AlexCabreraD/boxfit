        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-accent text-3xl md:text-4xl mb-4 text-boxing-black">
              ...
              <span className="text-boxing-red">DIFFERENCE</span>
            </h2>

            <p className="text-lg mb-6">
              At BoxFit Utah, we&#39;re passionate about boxing as both a
              competitive sport and a transformative fitness journey. Our
              experienced coaches guide you every step of the way, whether
              you&#39;re stepping into a gym for the first time or preparing for
