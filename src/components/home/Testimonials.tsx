...
const testimonials = [
    {
        ...
        quote: "I've tried many gyms over the years, but BoxFit Utah has completely transformed my fitness journey. The coaches are attentive and the community is so supportive. I've lost 25 pounds and gained confidence I never had before.",
        stars: 5
    },
    {
        name: 'Sarah T.',
        ...
        quote: "My son has been in the kids' program for 6 months, and the change in him is remarkable. He's more disciplined, focused in school, and his confidence has skyrocketed. The coaches are amazing with children!",
        stars: 5
    },
    {
        name: 'David L.',
        ...
        quote: 'Training at BoxFit has elevated my competitive game to levels I never thought possible. The professional coaching and personalized attention have helped me win my last three fights. This gym is the real deal.',
        stars: 5
    },
    {
        name: 'Elena M.',
        ...
        quote: 'I was intimidated to try boxing at first, but the team at BoxFit made me feel welcome from day one. As a complete beginner, I appreciate how they break down techniques and provide a supportive environment to learn.',
        stars: 5
    }
];
...
const Testimonials = () => {
    ...
    const renderStars = (count: number) => {
        return Array(count).fill(0).map((_, index) => (
            <FiStar key={index} className="text-accent-gold" />
        ));
    };
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-4xl mx-auto relative">
                    ...
                    <div className="bg-steel-gray bg-opacity-20 p-8 md:p-12 rounded-lg relative overflow-hidden">
                        <div className="w-24 h-24 bg-boxing-red opacity-20 rounded-full absolute -top-12 -right-12" aria-hidden="true" />
                        <div className="w-24 h-24 bg-accent-gold opacity-20 rounded-full absolute -bottom-12 -left-12" aria-hidden="true" />
                        ...
                        <div className={`transition-opacity duration-500 ${isAnimating ? 'opacity-0' : 'opacity-100'}`}>
                            <div className="flex flex-col md:flex-row md:items-center mb-6">
                                ...
                                <div>
                                    <h3 className="font-primary font-semibold text-xl">{testimonials[currentIndex].name}</h3>
                            ...
                            <blockquote className="italic text-lg md:text-xl relative">
                                <span className="font-accent text-6xl text-boxing-red absolute -top-6 -left-2 opacity-30">&#34;</span>
                                {testimonials[currentIndex].quote}
                                <span className="font-accent text-6xl text-boxing-red absolute -bottom-14 -right-2 opacity-30">&#34;</span>
                            </blockquote>
                        </div>
                    </div>
