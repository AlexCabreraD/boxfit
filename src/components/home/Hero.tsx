            ...
            <div className="container mx-auto px-4 relative z-10 py-20 md:py-32">
                <div className="max-w-3xl text-white">
                    <h1 className="font-accent text-5xl md:text-6xl lg:text-7xl mb-4 text-white">
                        TRANSFORM YOURSELF <span className="text-boxing-red">THROUGH BOXING</span>
                    </h1>

                    <h2 className="text-xl md:text-2xl mb-6 text-white font-primary">
                        Professional boxing training for all skill levels in Clearfield, Utah
                    </h2>

                    <p className="text-lg md:text-xl mb-8 max-w-2xl">
                        Whether you&#39;re a beginner or an experienced boxer, our professional coaches with 20+ years of experience will help you achieve your fitness goals and unleash your full potential.
                    </p>
