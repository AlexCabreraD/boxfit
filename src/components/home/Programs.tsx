...
const Programs = () => {
  const programCards = [
    ...
    },
    {
      ...
      description:
        "Age-appropriate training focused on discipline, confidence, and having fun.",
      link: "/programs#kids",
    },
    {
      ...
      description:
        "Advanced techniques and strategies for those interested in competitive boxing.",
    ...
    },
    {
      ...
      description:
        "High-intensity boxing workouts designed to improve overall fitness and conditioning.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto">
            Discover our range of boxing programs designed for all ages and
            skill levels
          </p>
        </div>
